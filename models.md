...
<div class="hero">
  <div class="container">
    ...
    <p class="hero-subtitle">New models, papers and benchmarks that move the state of the art.</p>
  </div>
</div>
...
(function() {
  ...
  Data.fetch().then(data => {
    ...
    if (!stories.length) { el.innerHTML = '<div class="empty-state"><h2>No major model developments yet.</h2></div>'; return; }
