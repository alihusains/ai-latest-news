    ...
    biggest(s) {
      return `<div class="card" style="margin-bottom:var(--space-2xl)">
        ...
        <div class="card-body">
          ...
          <div class="card-meta">
            <span>${s.reading_time}</span><span>·</span>
            <span>${Data.formatDate(s.published_at)}</span><span>·</span>
